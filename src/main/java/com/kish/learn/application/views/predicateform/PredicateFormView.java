package com.kish.learn.application.views.predicateform;
...
@PageTitle("Predicate Form")
@Route(value = "predicate-form", layout = MainLayout.class)
public class PredicateFormView extends Composite<VerticalLayout> {

    public PredicateFormView() {
